...
duet new --gateless --framing .duet/<name>.md                    # walk away from the START — every gate pre-authorized, consultant backstop-only
```
