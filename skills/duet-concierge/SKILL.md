...
| `done` | complete | report the summary — it leads with the PR link (both arcs open a PR; full a draft, rir a real one) |
...
duet new --workflow rir --framing .duet/<name>.md --gates-at afk  # rir, run straight through to done (real PR open)
```
