...
#                             spec → plan → implement → PR. blueprint: frame → design
#                             (one design doc replaces spec + plan) → implement →
...
#                             relay attend the design gate only (one interruption).
...
#                             FRAME (full: a spec; blueprint and relay: a design
#                             doc). Not short.
