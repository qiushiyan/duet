...
- **Gate interception** — `ask_human` and `advance_phase` tool calls are intercepted; the harness pauses/exits rather than letting the orchestrator proceed.
