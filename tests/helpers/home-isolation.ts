 ...
 *
 * The snippet user-override layer resolves from `<home>/.config/greenflag/snippets.toml`
 ...
 * real `~/.config/greenflag/snippets.toml` and diverge from a shipped-only baseline.
 *
 ...
 */
const EMPTY_HOME = mkdtempSync(join(tmpdir(), 'greenflag-test-home-'));
