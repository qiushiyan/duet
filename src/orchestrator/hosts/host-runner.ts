...
import { retryDecision } from '../../voices/health.ts';
...
// lives with the machine (its actor's input type); re-exported here so the
// host adapters keep one seam import.
import type { PhaseInput } from '../../run/machine.ts';
export type { PhaseInput } from '../../run/machine.ts';
