...
import { classifyError, currentTerminalError } from '../../voices/health.ts';
...
/**
 * The statechart provided with THIS host's phase driver — the in-process
 * runPhase wired into the grammar's `phaseDriver` slot via the same
 * `machine.provide` seam stdioPhaseMachine and interactiveMachineFor use.
